...
# Test: Image OCR - DeepSeek (Markdown Output)
# Tests DeepSeek OCR model with markdown output

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "${SCRIPT_DIR}/../../test-utils.sh"

print_test_header "image-ocr/104-deepseek-markdown" "DeepSeek OCR with markdown output"
...
echo "Test 1: OCR with DeepSeek OCR (markdown output)"
